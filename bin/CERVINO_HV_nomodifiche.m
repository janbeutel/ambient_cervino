...
% plot(vecbinf,HV1_c(:,3),'--m','Linewidth',1);zoom on; grid on; hold on;
    ...
    %Labels 
    %X
    %set(gca,'XTick',[2 4 6 8 10 20 30 50 100]);
    %set(gca,'XTickLabel',[2 4 6 8 10 20 30 50 100]);
    xlabel('Frequency (Hz)');
    ylabel('H/V (-)');
    %Grid
    grid on;
...
box on
% sdf('20_15')
% saveas(gcf,[savename '_time.jpg'])% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% saveas(gcf,[savename '_time.fig'])       
